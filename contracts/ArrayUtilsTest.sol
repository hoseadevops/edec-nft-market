...
contract ArrayUtilsTest {
    ...
    function compare() public pure returns(uint, uint, uint, uint) {
        uint a = ArrayUtils.unsafeWriteAddress(160, 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC);
        uint b = ArrayUtils.unsafeWriteAddressWord(160, 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC);
        uint c = ArrayUtils.unsafeWriteUint8(160, 100);
        uint d = ArrayUtils.unsafeWriteUint8Word(160, 100);
