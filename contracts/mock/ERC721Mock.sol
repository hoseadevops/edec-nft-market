...
contract ERC721Mock is ERC721, AccessControl {
  ...
  function mint(address _to, uint256 _tokenId) external onlyRole(DEFAULT_ADMIN_ROLE) {
    _mint(_to, _tokenId);
  }

  function batchMint(address _to, uint256[] calldata _tokenIds) external onlyRole(DEFAULT_ADMIN_ROLE) {
